...
<tr>
	...
	<td width="400">
		<input type="text" name="zipcode" size="7" value="<%=c.getZipcode()%>" readonly>
		<input type="button" value="우편번호찾기" onclick='javascript:window.open("ZipCheck.jsp?check=y", "post", "toolbar=no, width=500, height=300, directories=no, status=yes, scollbars=yes, menubar=no");'>
		우편 번호를 검색하세요.
	</td>
</tr>
...
<tr>
	<td>주소</td>
	<td>
		<input type="text" name="address" value="<%=c.getAddress()%>" size="70">
		주소를 적어 주세요.
	</td>
</tr>
