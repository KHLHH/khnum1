...
<body onLoad="focusIt();" bgcolor="<%=bodyback_c%>">
  <table width=500 cellpadding="0" cellspacing="0"  align="center" border="1" >
      ...
      <tr >
       ...
       <tr>
          <td colspan="3" bgcolor="<%=title_c%>"   align="center">
            <input type="button"  value="아이디 찾기" onclick="javascript:window.location='findId.jsp'">
            <input type="button"  value="비밀번호 찾기" onclick="javascript:window.location='findPw.jsp'">
          </td>
       </tr>
          </form>
          </table>
