...
public class BoardDBBean2_beforeComment {
	
	
	
	
	private static BoardDBBean2_beforeComment instance = new BoardDBBean2_beforeComment();
	
	public static BoardDBBean2_beforeComment getInstance(){
		return instance;
	}
	
	private BoardDBBean2_beforeComment(){}
